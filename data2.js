export default [
  ...
  {
    title:
      'T@@@@@ over the cost of training the attention mechanism to learn complex dependencies between distant inputs l,peag,p:mgmr@ to grow. In response, solutions that exploit the structure and sparsity of the learned attention matrix have blossomed. However, real-world applications that involve long sequences, such as',
    author: 'react',
